...
public class MyBatisTest {
	...
	@Test
	public void test01_01() throws IOException {
		// 1、获取sqlSessionFactory对象
		SqlSessionFactory sqlSessionFactory = getSqlSessionFactory();
		// 2、获取sqlSession对象
		SqlSession openSession = sqlSessionFactory.openSession();
		try {
			...
			//会为接口自动的创建一个代理对象，代理对象去执行增删改查方法
			EmployeeMapper mapper = openSession.getMapper(EmployeeMapper.class);
			List<Employee> employee = mapper.getEmpByIds();
			System.out.println(mapper.getClass());
			System.out.println(employee);
		} finally {
			openSession.close();
	...
	public void test03() throws IOException{
		...
		try{
			EmployeeMapper mapper = openSession.getMapper(EmployeeMapper.class);
			//测试添加
			Employee employee = new Employee(3, "jerry4",null, "1");
	...
	public void test06() throws IOException{
		...
		try{
			...
			/*sDepartment department = mapper.getDeptByIdPlus(1);
	...
	public void test08() throws IOException {
		...
		try {
			DepartmentMapper mapper = openSession.getMapper(DepartmentMapper.class);
			List<Department> departmetns = mapper.selectAllDepartment();
			System.out.println(departmetns);
		} finally {
			openSession.close();
		}
	}
	...
	public void testMap() throws IOException {
		...
		try {
			EmployeeMapper mapper = openSession.getMapper(EmployeeMapper.class);
			Map<String, Object> mapTest = mapper.getMapTest(2);
	...
	public void testMap2() throws IOException {
		...
		SqlSession openSession = sqlSessionFactory.openSession();
		try {
			List<Object> selectList = openSession.selectList("com.atguigu.mybatis.dao.EmployeeMapper.getMapTest", 1);
			System.out.println(selectList);
			
			Map<Object, Object> map = openSession.selectMap("com.atguigu.mybatis.dao.EmployeeMapper.getMapTest", "2");
			System.out.println(map);
		} finally {
			openSession.close();
		}
	...
	public void testMap3() throws IOException {
		...
		try {
			...
			map.put("id", 1);
			map.put("email", "%.com");
			List<Object> selectList = openSession.selectList("com.atguigu.mybatis.dao.EmployeeMapper.getMapTest2", map);
			System.out.println(selectList);
			
			
		/*	EmployeeMapper mapper = openSession.getMapper(EmployeeMapper.class);
			List mapTest2 = mapper.getMapTest2(1);
